...
public class Readability {
     ...
     */
    public static Integer getNumberOfComplexWords(String text) {
        String cleanText = Utilities.cleanLine(text);
     ...
     */
    public static Integer getNumberOfSyllables(String text) {
        String cleanText = Utilities.cleanLine(text);
        String[] word  = cleanText.split(" ");
        int syllables = 0;
        for (String w : word) {
    ...
    /* Easy to use interface for Flesch Kincaid Grade Level */
    public static Double getGradeScore(String text) {
        Readability r = new Readability(text);
        return r.getFleschKincaidGradeLevel();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Grade: " + getGradeScore(GreenEggsAndHam));

        // Usage with instance of class
